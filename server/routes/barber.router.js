 ...
 */
 router.post('/', (req, res, next) => {
  ...
  const specialties = req.body.specialties;
    ...
    pool
      .query(queryText, [barber.fullName, barber.pronouns, specialties, barber.phoneNumber, barber.website, barber.facebook, barber.instagram, barber.address, barber.avatar_link, barber.role])
