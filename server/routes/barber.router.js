 ...
 */
 router.post('/', (req, res, next) => {
  ...
  const barber = req.body;
    ...
    pool
      .query(queryText, [barber.fullName, barber.pronouns, barber.specialties, barber.phoneNumber, barber.website, barber.facebook, barber.instagram, barber.address, barber.avatar_link, barber.role])
